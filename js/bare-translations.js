...
(function() {
    ...
    const translations = {
        ...
        zh: {
                ...
                // 页面元数据
            "bare_page_title": "裸陶瓷基板 | 氧化铝(Al₂O₃)、氮化铝(AIN)、氮化硅(Si₃N₄)、碳化硅(SiC)、氧化锆(ZrO₂) | 吉美材料",
            "bare_page_description": "吉美材料提供高性能裸陶瓷基板，包括氧化铝、氮化铝、氮化硅、碳化硅及氧化锆，适用于半导体设备、功率电子及汽车系统等严苛应用。",
            "bare_page_keywords": "裸陶瓷基板, 氧化铝基板, 氮化铝基板, 氮化硅基板, 碳化硅基板, 氧化锆陶瓷, 热管理, 半导体, 功率电子",
            "og_title": "裸陶瓷基板 | 高性能陶瓷材料解决方案 | 吉美材料",
            "og_description": "提供氧化铝、氮化铝、氮化硅、碳化硅及氧化锆等高性能裸陶瓷基板，适用于高温及严苛工况下的各类应用。",
            "twitter_title": "裸陶瓷基板 | 高性能陶瓷材料解决方案 | 吉美材料",
