(function() {
    ...
    const translations = {
        ...
        zh: {
                    // Page meta
            'terms_page_title': '服务条款 | 吉美材料 - 陶瓷基板制造商',
            'terms_meta_description': '吉美材料网站与服务条款。规范使用我们网站、产品及服务的法律条款。',
            ...
            'terms_intro_note': '本《服务条款》（简称“条款”）规范您对吉美材料有限公司网站 (www.jimei-materials.com) 及我们服务的访问和使用。本条款构成您与吉美材料有限公司之间具有法律约束力的协议。',
            ...
            'terms_section2_list1': '“公司”、“我们”或“我方”指依据中国法律注册成立的吉美材料有限公司。',
            ...
            'terms_section6_content': '我们网站上的所有内容、特性和功能均为吉美材料有限公司、其许可方或其他提供方所有，并受国际版权、商标、专利、商业秘密及其他知识产权法保护。',
            
            'terms_section6a_title': '6.1 版权',
            'terms_section6a_content': '本网站及其全部内容、特性和功能（包括但不限于所有信息、软件、文本、展示、图像、视频、音频及其设计、选择和编排）归吉美材料有限公司、其许可方或此类材料的其他提供方所有，并受版权法保护。',
            
            'terms_section6b_title': '6.2 商标',
            'terms_section6b_content': '“吉美材料”名称、徽标及所有相关名称、徽标、产品和服务名称、设计和标语均为吉美材料有限公司或其关联公司或许可方的商标。未经我们事先书面许可，您不得使用此类标记。',
            ...
            'terms_section9_content': '我们的网站可能包含指向非吉美材料所有或控制的第三方网站或服务的链接。我们对任何第三方网站或服务的内容、隐私政策或实践概不控制，也不承担任何责任。您承认并同意，对于因使用或依赖任何此类网站或服务上或通过其提供的任何此类内容、商品或服务而造成或据称造成的任何损害或损失，吉美材料概不负责，无论直接或间接。',
            
            'terms_section10_title': '10. 免责声明',
            'terms_section10_content': '您使用我们的网站和服务风险自担。网站和服务按“原样”和“现有”基础提供。吉美材料明确声明不提供任何形式的明示或暗示保证，包括但不限于对适销性、特定用途适用性和不侵权的暗示保证。',
            ...
            'terms_section11_content': '在适用法律允许的最大范围内，对于因以下原因导致的任何间接、附带、特殊、后果性或惩罚性损害（包括但不限于利润、数据、使用、商誉或其他无形损失的损失），吉美材料不承担任何责任：',
            ...
            'terms_section11_content2': '在任何情况下，吉美材料对您提出的所有索赔的总责任不得超过一百美元（USD 100.00）。',
            
            'terms_section12_title': '12. 赔偿',
            'terms_section12_content': '您同意为吉美材料有限公司、其关联公司、许可方和服务提供商，及其各自的负责人、董事、员工、承包商、代理人、许可方、供应商、继承人和受让人进行辩护、赔偿并使其免受损害，赔偿范围包括因您违反本条款或使用网站而引起或与之相关的任何索赔、责任、损害、判决、裁决、损失、成本、开支或费用（包括合理的律师费）。',
            ...
            'terms_section17_content': '本条款构成您与吉美材料之间关于我们网站的完整协议，并取代和替换我们之间先前就网站达成的任何协议。',
            
            'terms_section18_title': '18. 弃权',
            'terms_section18_content': '我们未能执行本条款的任何权利或规定，不应被视为对该等权利的放弃。对该等权利或规定的任何弃权，仅在经吉美材料正式授权代表书面签署后方为有效。',
