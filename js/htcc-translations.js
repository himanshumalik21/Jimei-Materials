...
(function () {
    ...
    const translations = {
        en: {
            ...
            "layer_highlight_desc": "Monolithic multilayer structures with complex internal routing",
            ...
            "feature_multilayer_desc": "Multilayer routing with 100-150μm vias and fine-line resolution for complex 3D packaging solutions.",
            ...
            "cta_prototyping_desc": "Typical lead time ~6-8 weeks",
        ...
        zh: {
            ...
            "feature_extreme_temp": "高温与严苛恶劣环境稳定性",
            ...
            "feature_hermeticity_desc": "氦气泄漏率 <1×10⁻⁸ atm·cc/s (氦气检漏测试)，为敏感电子元件提供完整的环境防护。",
            "feature_temperature_title": "极端的温度稳定性",
            "feature_temperature_desc": "在严苛极端环境条件下具备出色的热稳定性和耐化学性。",
        ...
        ja: {
            ...
            "feature_extreme_temp": "高温・過酷環境対応",
            ...
            "feature_hermeticity_desc": "ヘリウムリーク率 <1×10⁻⁸ atm·cc/s（ヘリウムリーク試験済）により、敏感な電子機器を完全に環境から保護します。",
            "feature_temperature_title": "極限温度安定性",
            "feature_temperature_desc": "過酷な環境条件下で優れた熱的・化学的安定性を発揮します。",
        ...
        ko: {
            ...
            "feature_extreme_temp": "고온 및 가혹 환경 내구성",
            ...
            "feature_hermeticity_desc": "헬륨 누출율 <1×10⁻⁸ atm·cc/s (헬륨 누출 시험 완료)로 민감한 전자 장치의 완전한 환경 보호가 가능합니다.",
            "feature_temperature_title": "극한 온도 안정성",
            "feature_temperature_desc": "가혹한 환경 조건에서도 탁월한 열적 및 화학적 안정성 유지.",
            ...
            "cta_prototyping_desc": "표준 리드타임 약 6-8주",
        ...
        de: {
            ...
            "feature_extreme_temp": "Hohe Temperaturen & raue Umgebungen",
            ...
            "feature_hermeticity_desc": "Helium-Leckrate <1×10⁻⁸ atm·cm³/s (Helium-Leckprüfung geprüft) für vollständigen Umweltschutz empfindlicher Elektronik.",
            "feature_temperature_title": "Extreme Temperaturstabilität",
            "feature_temperature_desc": "Ausgezeichnete thermische und chemische Beständigkeit unter extremen Umgebungsbedingungen.",
