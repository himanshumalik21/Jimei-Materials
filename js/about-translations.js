...
(function() {
    ...
    const translations = {
        ...
        zh: {
        // 元标签 - 强调“关于我们”及企业定位
        "about_page_title": "关于集美材料 | 领先的陶瓷基板制造商",
        "about_meta_description": "集美材料：自2016年成立的陶瓷金属化基板领先制造商。专注于为功率电子、电动汽车、半导体及热管理应用提供DBC、DPC及裸陶瓷基板解决方案。通过ISO 14001:2015认证。",
        "about_meta_keywords": "陶瓷基板制造商, DBC基板生产商, DPC基板厂家, 关于集美材料, 陶瓷金属化公司, 热管理解决方案, 功率电子基板, 半导体封装制造商, 氮化铝基板, 氧化铝基板",
        "about_og_title": "关于集美材料 | 陶瓷基板制造商 | DBC与DPC解决方案专家",
        "about_og_description": "通过ISO 14001:2015认证的陶瓷金属化基板领先制造商。专注于为功率电子和热管理领域提供DBC、DPC及裸陶瓷基板解决方案。",
        "about_twitter_title": "关于集美材料 | 陶瓷基板制造商 | DBC与DPC解决方案专家",
        ...
        "about_image_alt": "集美材料现代化生产车间",

        // 公司概况
        "overview_title": "我们的使命",
        "overview_mission": "通过创新的陶瓷基板解决方案推动热管理技术进步，赋能更高效、更可靠、更可持续的功率电子系统。",
        "overview_description": "集美材料成立于2016年，现已发展成为高性能陶瓷金属化基板的领先制造商。我们专注于直接覆铜和直接镀铜技术，服务于从电动汽车、可再生能源到半导体封装和通信设备等诸多行业，以卓越的品质和可靠的技术解决方案支持全球客户。",
        ...
        "timeline_2016_desc": "集美材料在中国深圳成立，初期专注于服务本地电子行业的陶瓷基板制造。",
        ...
        // CTA区
        "about_cta_title": "携手集美，共创未来",
        "about_cta_description": "加入全球众多领先企业的行列，信赖集美材料，满足您对高性能陶瓷基板的需求。",
        "cta_expertise": "专业技术",
        ...
        "about_meta_description": "Jimei Materials（深圳集美材料科技有限公司）は、2016年創業のセラミックメタライゼーション基板のリーディングメーカーです。パワーエレクトロニクス、EV、半導体、熱管理アプリケーション向けにDBC、DPC、未金属化セラミック基板を専門に製造。ISO 14001:2015認証取得。",
