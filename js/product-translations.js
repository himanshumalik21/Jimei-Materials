...
(function () {
    ...
    const translations = {
        en: {
            ...
            "category_dpc_title": "Direct Plated Copper (DPC)",
            ...
            "category_dbc_title": "Direct Bonded Copper (DBC)",
            ...
            "category_bare_title": "Bare Ceramic Substrates",
            ...
            "dpc_thermal_conductivity": "Al₂O₃: 24-28 W/mK AlN: 170-200 W/mK Through-thickness",
            "dpc_thermal_note": "Through-thickness",
            "dbc_thermal_conductivity": "Al₂O₃: 24-28 W/mK AlN: 170-200 W/mK Through-thickness",
            "dbc_thermal_note": "Through-thickness",
            "htcc_thermal_conductivity": "Al₂O₃-based: 15-30 W/mK Note: Conductor is W/Mo (not Cu) Lower than DPC/DBC due to W/Mo metallization",
            ...
            "dpc_conductor": "Electroplated Copper (Cu) Typical resistivity: 1.7 μΩ·cm",
            "dpc_conductor_note": "Typical resistivity: 1.7 μΩ·cm",
            "dbc_conductor": "Bonded Copper Foil (Cu) Oxygen-free copper, typical 99.99% purity",
            "dbc_conductor_note": "Oxygen-free copper, typical 99.99% purity",
            "htcc_conductor": "Tungsten (W) or Molybdenum (Mo) Co-fired with ceramic, requires post-plating",
            "htcc_conductor_note": "Co-fired with ceramic, requires post-plating",

            "feature_conductor_thickness": "Conductor Thickness",
            "dpc_conductor_thickness": "5-100 μm (plated) Controlled by electroplating time",
            "dpc_conductor_thickness_note": "Controlled by electroplating time",
            "dbc_conductor_thickness": "100-300 μm (foil) Standard: 0.2mm, 0.3mm, 0.4mm",
            "dbc_conductor_thickness_note": "Standard: 0.2mm, 0.3mm, 0.4mm",
            "htcc_conductor_thickness": "10-20 μm (printed) After co-firing (before plating)",
            "htcc_conductor_thickness_note": "After co-firing (before plating)",

            "feature_line_width": "Min. Line/Space Width",
            "dpc_line_width": "20/20 μm Using photolithography",
            "dpc_line_width_note": "Using photolithography",
            "dbc_line_width": "150/150 μm Laser cut or chemically etched",
            "dbc_line_width_note": "Laser cut or chemically etched",
            "htcc_line_width": "100/100 μm Screen printed, co-fired",
            "htcc_line_width_note": "Screen printed, co-fired",

            "feature_via": "Via Diameter (Min)",
            "dpc_via": "50 μm (laser drilled) Plated through hole",
            "dpc_via_note": "Plated through hole",
            "dbc_via": "Not typical Possible with additional processing",
            "dbc_via_note": "Possible with additional processing",
            "htcc_via": "100 μm (punched) Filled with W/Mo paste",
            "htcc_via_note": "Filled with W/Mo paste",

            "feature_bond_strength": "Bond Strength (Ceramic to Metal)",
            "dpc_bond_strength": "30-40 MPa Ti/Cu seed layer adhesion",
            "dpc_bond_strength_note": "Ti/Cu seed layer adhesion",
            "dbc_bond_strength": ">20 MPa Cu-O eutectic bond",
            "dbc_bond_strength_note": "Cu-O eutectic bond",
            "htcc_bond_strength": "Integral (co-fired) No separate bond interface",
            "htcc_bond_strength_note": "No separate bond interface",

            "feature_surface_finish": "Surface Finish Options",
            "dpc_surface_finish": "ENIG, ENEPIG, Immersion Sn Electroplated Ni/Au, OSP Directly on plated copper",
            "dpc_surface_finish_note": "Directly on plated copper",
            "dbc_surface_finish": "Bare copper, Immersion Sn ENIG, Direct solder coating May require Ni barrier layer",
            "dbc_surface_finish_note": "May require Ni barrier layer",
            "htcc_surface_finish": "ENIG, ENEPIG required Electroplated Ni/Au/Sn W/Mo not solderable as-fired",
            "htcc_surface_finish_note": "W/Mo not solderable as-fired",

            "feature_thermal_cycling": "Thermal Cycling Performance",
            "dpc_thermal_cycling": "-55°C to 150°C, 500 cycles Limited by plated copper CTE mismatch",
            "dpc_thermal_cycling_note": "Limited by plated copper CTE mismatch",
            "dbc_thermal_cycling": "-55°C to 150°C, 1000+ cycles Excellent for power cycling",
            "dbc_thermal_cycling_note": "Excellent for power cycling",
            "htcc_thermal_cycling": "-55°C to 150°C, 1000+ cycles Excellent hermetic stability",
            "htcc_thermal_cycling_note": "Excellent hermetic stability",

            "feature_multilayer": "Multilayer Capability",
            "dpc_multilayer": "1-2 conductive layers Double-sided with PTH vias",
            ...
            "dpc_apps": "• RF/Microwave Circuits • Fine-Pitch LED Arrays • Sensor Packages • TEC Modules Where precision features needed",
            "dpc_apps_note": "Where precision features needed",
            "dbc_apps": "• IGBT Power Modules • EV Traction Inverters • High-Current Bus Bars • Solar Inverters High power, high current",
            "dbc_apps_note": "High power, high current",
            "htcc_apps": "• Hermetic RF Packages • Aerospace Electronics • Multi-Chip Modules (MCM) • High-Reliability Sensors Extreme environments",
            "htcc_apps_note": "Extreme environments",

            "feature_cost": "Relative Cost Factor",
            "dpc_cost": "Medium to High Photolithography adds cost",
            "dpc_cost_note": "Photolithography adds cost",
            "dbc_cost": "Low to Medium Bulk process, good for large areas",
            "dbc_cost_note": "Bulk process, good for large areas",
            "htcc_cost": "High (setup) Medium (volume) High NRE, economies of scale",
            ...
            "dpc_recommendation": "Choose DPC when: • Fine features <100μm required • ENIG/ENEPIG finish needed • RF performance critical • Low volume, quick prototype",
            "dbc_recommendation_title": "Choose DBC when:",
            "dbc_recommendation": "Choose DBC when: • High current (>50A) required • Superior thermal cycling needed • Thick copper (0.3mm+) required • Cost-sensitive high volume",
            "htcc_recommendation_title": "Choose HTCC when:",
            "htcc_recommendation": "Choose HTCC when: • Hermetic sealing required • Multilayer (>4 layers) needed • 3D structures/cavities needed • Extreme environment operation",
        ...
        zh: {
            ...
            "category_dpc_title": "直接镀铜基板 (DPC)",
            "category_dpc_desc": "适用于射频/微波应用、半导体封装及精细线路的高精度陶瓷基板，提供卓越的电性能。",
            "category_dbc_title": "直接覆铜基板 (DBC)",
            ...
            "dpc_thermal_conductivity": "Al₂O₃: 24-28 W/mK AlN: 170-200 W/mK 法向导热",
            "dpc_thermal_note": "法向导热",
            "dbc_thermal_conductivity": "Al₂O₃: 24-28 W/mK AlN: 170-200 W/mK 法向导热",
            "dbc_thermal_note": "法向导热",
            "htcc_thermal_conductivity": "氧化铝基: 15-30 W/mK 注： 导体为 W/Mo（非铜） 因使用钨/钼导体，导热性低于 DPC/DBC",
            "htcc_thermal_note1": "注：",
            "htcc_thermal_note2": "导体为 W/Mo（非铜）",
            "htcc_thermal_note3": "因使用钨/钼导体，导热性低于 DPC/DBC",

            "feature_conductor": "导体材料",
            "dpc_conductor": "电镀铜 (Cu) 典型电阻率：1.7 μΩ·cm",
            "dpc_conductor_note": "典型电阻率：1.7 μΩ·cm",
            "dbc_conductor": "键合铜箔 (Cu) 无氧铜，典型纯度 99.99%",
            "dbc_conductor_note": "无氧铜，典型纯度 99.99%",
            "htcc_conductor": "钨 (W) 或钼 (Mo) 与陶瓷共烧，需后电镀处理",
            "htcc_conductor_note": "与陶瓷共烧，需后电镀处理",

            "feature_conductor_thickness": "导体厚度",
            "dpc_conductor_thickness": "5-100 μm (电镀) 由电镀时间控制",
            "dpc_conductor_thickness_note": "由电镀时间控制",
            "dbc_conductor_thickness": "100-300 μm (箔材) 标准厚度：0.2mm， 0.3mm， 0.4mm",
            "dbc_conductor_thickness_note": "标准厚度：0.2mm， 0.3mm， 0.4mm",
            "htcc_conductor_thickness": "10-20 μm (印刷后) 共烧后（电镀前）",
            "htcc_conductor_thickness_note": "共烧后（电镀前）",

            "feature_line_width": "最小线宽/线距",
            "dpc_line_width": "20/20 μm 采用光刻工艺",
            "dpc_line_width_note": "采用光刻工艺",
            "dbc_line_width": "150/150 μm 激光切割或化学蚀刻",
            "dbc_line_width_note": "激光切割或化学蚀刻",
            "htcc_line_width": "100/100 μm 丝网印刷，共烧",
            "htcc_line_width_note": "丝网印刷，共烧",

            "feature_via": "通孔直径 (最小)",
            "dpc_via": "50 μm (激光钻孔) 镀通孔",
            "dpc_via_note": "镀通孔",
            "dbc_via": "不典型 可通过附加工艺实现",
            "dbc_via_note": "可通过附加工艺实现",
            "htcc_via": "100 μm (冲孔) 填充钨/钼浆料",
            "htcc_via_note": "填充钨/钼浆料",

            "feature_bond_strength": "结合强度 (陶瓷-金属)",
            "dpc_bond_strength": "30-40 MPa Ti/Cu 种子层附着力",
            "dpc_bond_strength_note": "Ti/Cu 种子层附着力",
            "dbc_bond_strength": ">20 MPa 铜-氧共晶键合",
            "dbc_bond_strength_note": "铜-氧共晶键合",
            "htcc_bond_strength": "一体成型 (共烧) 无独立的结合界面",
            "htcc_bond_strength_note": "无独立的结合界面",

            "feature_surface_finish": "表面处理选项",
            "dpc_surface_finish": "ENIG， ENEPIG， 化学浸锡 电镀镍/金， OSP 直接在电镀铜上处理",
            "dpc_surface_finish_note": "直接在电镀铜上处理",
            "dbc_surface_finish": "裸铜， 化学浸锡 ENIG， 直接焊料涂覆 可能需要镍阻挡层",
            "dbc_surface_finish_note": "可能需要镍阻挡层",
            "htcc_surface_finish": "需 ENIG/ENEPIG 处理 电镀镍/金/锡 烧结后的钨/钼不可焊",
            "htcc_surface_finish_note": "烧结后的钨/钼不可焊",

            "feature_thermal_cycling": "热循环性能",
            "dpc_thermal_cycling": "-55°C 至 150°C， 500 次循环 受电镀铜热膨胀系数不匹配限制",
            "dpc_thermal_cycling_note": "受电镀铜热膨胀系数不匹配限制",
            "dbc_thermal_cycling": "-55°C 至 150°C， 1000+ 次循环 优异的功率循环耐受性",
            "dbc_thermal_cycling_note": "优异的功率循环耐受性",
            "htcc_thermal_cycling": "-55°C 至 150°C， 1000+ 次循环 优异的气密稳定性",
            "htcc_thermal_cycling_note": "优异的气密稳定性",

            "feature_multilayer": "多层能力",
            "dpc_multilayer": "1-2 导电层 双面带镀通孔",
            ...
            "dpc_apps": "• 射频/微波电路 • 精细间距 LED 阵列 • 传感器封装 • TEC 模块 适用于需要精密特征的场景",
            "dpc_apps_note": "适用于需要精密特征的场景",
            "dbc_apps": "• IGBT 功率模块 • 电动汽车牵引逆变器 • 高电流汇流排 • 光伏逆变器 高功率， 大电流",
            "dbc_apps_note": "高功率， 大电流",
            "htcc_apps": "• 气密射频封装 • 航空航天电子 • 多芯片模块 • 高可靠性传感器 极端环境",
            "htcc_apps_note": "极端环境",

            "feature_cost": "相对成本因素",
            "dpc_cost": "中到高 光刻工艺增加成本",
            "dpc_cost_note": "光刻工艺增加成本",
            "dbc_cost": "低到中 批量工艺， 适合大面积",
            "dbc_cost_note": "批量工艺， 适合大面积",
            "htcc_cost": "高 (开模费) 中 (批量) 高一次性工程费用， 具规模效应",
            ...
            "dpc_recommendation": "选择 DPC 当您需要： • 特征尺寸 <100μm • ENIG/ENEPIG 表面处理 • 射频性能至关重要 • 小批量快速打样",
            "dbc_recommendation_title": "选择 DBC 当您需要：",
            "dbc_recommendation": "选择 DBC 当您需要： • 承载大电流 (>50A) • 优异的热循环性能 • 厚铜 (0.3mm+) • 成本敏感的大批量生产",
            "htcc_recommendation_title": "选择 HTCC 当您需要：",
            "htcc_recommendation": "选择 HTCC 当您需要： • 气密性封装 • 多层 (>4层) 结构 • 3D 结构/腔体 • 极端环境运行",
        ...
        ja: {
            ...
            "dpc_thermal_conductivity": "Al₂O₃: 24-28 W/mK AlN: 170-200 W/mK 厚み方向",
            "dpc_thermal_note": "厚み方向",
            "dbc_thermal_conductivity": "Al₂O₃: 24-28 W/mK AlN: 170-200 W/mK 厚み方向",
            "dbc_thermal_note": "厚み方向",
            "htcc_thermal_conductivity": "Al₂O₃ベース: 15-30 W/mK 注: 導体はW/Mo（銅ではない） W/MoメタライゼーションによりDPC/DBCよりも低い",
            "htcc_thermal_note1": "注:",
            "htcc_thermal_note2": "導体はW/Mo（銅ではない）",
            "htcc_thermal_note3": "W/MoメタライゼーションによりDPC/DBCよりも低い",

            "feature_conductor": "導体材料",
            "dpc_conductor": "電気めっき銅 (Cu) 代表的な抵抗率: 1.7 μΩ·cm",
            "dpc_conductor_note": "代表的な抵抗率: 1.7 μΩ·cm",
            "dbc_conductor": "接合銅箔 (Cu) 無酸素銅、代表的な純度99.99%",
            "dbc_conductor_note": "無酸素銅、代表的な純度99.99%",
            "htcc_conductor": "タングステン (W) またはモリブデン (Mo) セラミックと共焼、後めっきが必要",
            "htcc_conductor_note": "セラミックと共焼、後めっきが必要",

            "feature_conductor_thickness": "導体厚",
            "dpc_conductor_thickness": "5-100 μm (めっき) 電気めっき時間により制御",
            "dpc_conductor_thickness_note": "電気めっき時間により制御",
            "dbc_conductor_thickness": "100-300 μm (箔) 標準: 0.2mm, 0.3mm, 0.4mm",
            "dbc_conductor_thickness_note": "標準: 0.2mm, 0.3mm, 0.4mm",
            "htcc_conductor_thickness": "10-20 μm (印刷後) 共焼後（めっき前）",
            "htcc_conductor_thickness_note": "共焼後（めっき前）",

            "feature_line_width": "最小線幅/間隔",
            "dpc_line_width": "20/20 μm フォトリソグラフィ使用",
            "dpc_line_width_note": "フォトリソグラフィ使用",
            "dbc_line_width": "150/150 μm レーザー切断または化学エッチング",
            "dbc_line_width_note": "レーザー切断または化学エッチング",
            "htcc_line_width": "100/100 μm スクリーン印刷、共焼",
            "htcc_line_width_note": "スクリーン印刷、共焼",

            "feature_via": "ビア径（最小）",
            "dpc_via": "50 μm (レーザー穴あけ) スルーホールめっき",
            "dpc_via_note": "スルーホールめっき",
            "dbc_via": "一般的ではない 追加処理で可能",
            "dbc_via_note": "追加処理で可能",
            "htcc_via": "100 μm (パンチング) W/Moペースト充填",
            "htcc_via_note": "W/Moペースト充填",

            "feature_bond_strength": "接合強度（セラミック-金属間）",
            "dpc_bond_strength": "30-40 MPa Ti/Cuシード層密着性",
            "dpc_bond_strength_note": "Ti/Cuシード層密着性",
            "dbc_bond_strength": ">20 MPa Cu-O共晶接合",
            "dbc_bond_strength_note": "Cu-O共晶接合",
            "htcc_bond_strength": "一体構造（共焼） 独立した接合界面なし",
            "htcc_bond_strength_note": "独立した接合界面なし",

            "feature_surface_finish": "表面仕上げオプション",
            "dpc_surface_finish": "ENIG, ENEPIG, 置換Sn 電気めっきNi/Au, OSP めっき銅上直接",
            "dpc_surface_finish_note": "めっき銅上直接",
            "dbc_surface_finish": "ベア銅, 置換Sn ENIG, 直接はんだコーティング Niバリア層が必要な場合あり",
            "dbc_surface_finish_note": "Niバリア層が必要な場合あり",
            "htcc_surface_finish": "ENIG, ENEPIG 必須 電気めっきNi/Au/Sn 焼成直後のW/Moははんだ付け不可",
            "htcc_surface_finish_note": "焼成直後のW/Moははんだ付け不可",

            "feature_thermal_cycling": "熱サイクリング性能",
            "dpc_thermal_cycling": "-55°C〜150°C, 500サイクル めっき銅のCTE不一致により制限",
            "dpc_thermal_cycling_note": "めっき銅のCTE不一致により制限",
            "dbc_thermal_cycling": "-55°C〜150°C, 1000+サイクル パワーサイクリングに優れる",
            "dbc_thermal_cycling_note": "パワーサイクリングに優れる",
            "htcc_thermal_cycling": "-55°C〜150°C, 1000+サイクル 優れた気密安定性",
            "htcc_thermal_cycling_note": "優れた気密安定性",

            "feature_multilayer": "多層化能力",
            "dpc_multilayer": "1-2導体層 スルーホールビアによる両面実装",
            ...
            "dpc_apps": "• RF/マイクロ波回路 • 微細ピッチLEDアレイ • センサーパッケージ • TECモジュール 高精度特性が求められる用途",
            "dpc_apps_note": "高精度特性が求められる用途",
            "dbc_apps": "• IGBTパワーモジュール • EVトラクションインバーター • 大電流バスバー • 太陽光インバーター 高出力、大電流",
            "dbc_apps_note": "高出力、大電流",
            "htcc_apps": "• 気密RFパッケージ • 航空宇宙電子機器 • マルチチップモジュール (MCM) • 高信頼性センサー 極限環境",
            "htcc_apps_note": "極限環境",

            "feature_cost": "相対コスト要因",
            "dpc_cost": "中〜高 フォトリソグラフィがコスト増",
            "dpc_cost_note": "フォトリソグラフィがコスト増",
            "dbc_cost": "低〜中 バルクプロセス、広面積に適す",
            "dbc_cost_note": "バルクプロセス、広面積に適す",
            "htcc_cost": "高（セットアップ） 中（量産） NRE高、規模の経済あり",
            ...
            "dpc_recommendation": "DPCを選択する場合: • 100μm未満の微細特性が必要 • ENIG/ENEPIG仕上げが必要 • RF性能が重要 • 少量、迅速な試作",
            "dbc_recommendation_title": "DBCを選択する場合:",
            "dbc_recommendation": "DBCを選択する場合: • 大電流 (>50A) が必要 • 優れた熱サイクリングが必要 • 厚銅 (0.3mm以上) が必要 • コスト重視の量産",
            "htcc_recommendation_title": "HTCCを選択する場合:",
            "htcc_recommendation": "HTCCを選択する場合: • 気密封装が必要 • 多層（4層以上）が必要 • 3D構造/キャビティが必要 • 極限環境動作",
        ...
        ko: {
            ...
            "dpc_thermal_conductivity": "Al₂O₃: 24-28 W/mK AlN: 170-200 W/mK 두께 방향",
            "dpc_thermal_note": "두께 방향",
            "dbc_thermal_conductivity": "Al₂O₃: 24-28 W/mK AlN: 170-200 W/mK 두께 방향",
            "dbc_thermal_note": "두께 방향",
            "htcc_thermal_conductivity": "알루미나 기반: 15-30 W/mK 참고: 도체는 W/Mo(구리 아님) W/Mo 금속화로 인해 DPC/DBC보다 낮음",
            ...
            "dpc_conductor": "전해 도금 구리 (Cu) 일반적 저항률: 1.7 μΩ·cm",
            "dpc_conductor_note": "일반적 저항률: 1.7 μΩ·cm",
            "dbc_conductor": "접합 구리 포일 (Cu) 무산소 구리, 일반적 순도 99.99%",
            "dbc_conductor_note": "무산소 구리, 일반적 순도 99.99%",
            "htcc_conductor": "텅스텐 (W) 또는 몰리브덴 (Mo) 세라믹과 동시 소성, 후속 도금 필요",
            "htcc_conductor_note": "세라믹과 동시 소성, 후속 도금 필요",

            "feature_conductor_thickness": "도체 두께",
            "dpc_conductor_thickness": "5-100 μm (도금) 전해 도금 시간으로 제어",
            "dpc_conductor_thickness_note": "전해 도금 시간으로 제어",
            "dbc_conductor_thickness": "100-300 μm (포일) 표준: 0.2mm, 0.3mm, 0.4mm",
            "dbc_conductor_thickness_note": "표준: 0.2mm, 0.3mm, 0.4mm",
            "htcc_conductor_thickness": "10-20 μm (인쇄) 동시 소성 후 (도금 전)",
            "htcc_conductor_thickness_note": "동시 소성 후 (도금 전)",

            "feature_line_width": "최소 선폭/간격",
            "dpc_line_width": "20/20 μm 포토리소그래피 사용",
            "dpc_line_width_note": "포토리소그래피 사용",
            "dbc_line_width": "150/150 μm 레이저 절단 또는 화학적 에칭",
            "dbc_line_width_note": "레이저 절단 또는 화학적 에칭",
            "htcc_line_width": "100/100 μm 스크린 인쇄, 동시 소성",
            "htcc_line_width_note": "스크린 인쇄, 동시 소성",

            "feature_via": "비아 직경 (최소)",
            "dpc_via": "50 μm (레이저 드릴) 도금 관통 홀",
            "dpc_via_note": "도금 관통 홀",
            "dbc_via": "일반적 아님 추가 공정으로 가능",
            "dbc_via_note": "추가 공정으로 가능",
            "htcc_via": "100 μm (펀칭) W/Mo 페이스트 충전",
            "htcc_via_note": "W/Mo 페이스트 충전",

            "feature_bond_strength": "접합 강도 (세라믹-금속)",
            "dpc_bond_strength": "30-40 MPa Ti/Cu 시드층 접착력",
            "dpc_bond_strength_note": "Ti/Cu 시드층 접착력",
            "dbc_bond_strength": ">20 MPa Cu-O 공융 접합",
            "dbc_bond_strength_note": "Cu-O 공융 접합",
            "htcc_bond_strength": "일체형 (동시 소성) 별도 접합 계면 없음",
            "htcc_bond_strength_note": "별도 접합 계면 없음",

            "feature_surface_finish": "표면 처리 옵션",
            "dpc_surface_finish": "ENIG, ENEPIG, 침지 Sn 전해 도금 Ni/Au, OSP 도금 구리 위 직접",
            "dpc_surface_finish_note": "도금 구리 위 직접",
            "dbc_surface_finish": "베어 구리, 침지 Sn ENIG, 직접 솔더 코팅 Ni 차단층 필요할 수 있음",
            "dbc_surface_finish_note": "Ni 차단층 필요할 수 있음",
            "htcc_surface_finish": "ENIG, ENEPIG 필요 전해 도금 Ni/Au/Sn W/Mo는 소성 상태로 납땜 불가",
            "htcc_surface_finish_note": "W/Mo는 소성 상태로 납땜 불가",

            "feature_thermal_cycling": "열 사이클링 성능",
            "dpc_thermal_cycling": "-55°C ~ 150°C, 500회 도금 구리 열팽창 계수 불일치로 제한",
            "dpc_thermal_cycling_note": "도금 구리 열팽창 계수 불일치로 제한",
            "dbc_thermal_cycling": "-55°C ~ 150°C, 1000+회 파워 사이클링에 우수",
            "dbc_thermal_cycling_note": "파워 사이클링에 우수",
            "htcc_thermal_cycling": "-55°C ~ 150°C, 1000+회 우수한 기밀 안정성",
            "htcc_thermal_cycling_note": "우수한 기밀 안정성",

            "feature_multilayer": "다층 구현 능력",
            "dpc_multilayer": "1-2 도전층 PTH 비아 양면",
            ...
            "dpc_apps": "• RF/마이크로파 회로 • 미세 피치 LED 배열 • 센서 패키지 • TEC 모듈 정밀 특성이 필요한 경우",
            "dpc_apps_note": "정밀 특성이 필요한 경우",
            "dbc_apps": "• IGBT 파워 모듈 • EV 트랙션 인버터 • 고전류 버스바 • 태양광 인버터 고출력, 고전류",
            "dbc_apps_note": "고출력, 고전류",
            "htcc_apps": "• 기밀 RF 패키지 • 항공우주 전자 장치 • 다중 칩 모듈 (MCM) • 고신뢰성 센서 극한 환경",
            "htcc_apps_note": "극한 환경",

            "feature_cost": "상대적 비용 요소",
            "dpc_cost": "중간 ~ 높음 포토리소그래피로 인한 추가 비용",
            "dpc_cost_note": "포토리소그래피로 인한 추가 비용",
            "dbc_cost": "낮음 ~ 중간 대량 공정, 넓은 면적에 적합",
            "dbc_cost_note": "대량 공정, 넓은 면적에 적합",
            "htcc_cost": "높음 (설정) 중간 (대량) 높은 NRE, 규모의 경제",
            ...
            "dpc_recommendation": "DPC 선택 시기: • 미세 특성 <100μm 필요 • ENIG/ENEPIG 처리 필요 • RF 성능이 중요 • 소량, 빠른 프로토타입",
            "dbc_recommendation_title": "DBC 선택 시기:",
            "dbc_recommendation": "DBC 선택 시기: • 고전류 (>50A) 필요 • 우수한 열 사이클링 필요 • 두꺼운 구리 (0.3mm+) 필요 • 비용 민감 대량 생산",
            "htcc_recommendation_title": "HTCC 선택 시기:",
            "htcc_recommendation": "HTCC 선택 시기: • 기밀 밀봉 필요 • 다층 (>4층) 필요 • 3D 구조/캐비티 필요 • 극한 환경 작동",
        ...
        de: {
            ...
            "category_bare_title": "Unbeschichtete Keramiksubstrate",
            ...
            "dpc_thermal_conductivity": "Al₂O₃: 24-28 W/mK AlN: 170-200 W/mK In Dickenrichtung",
            "dpc_thermal_note": "In Dickenrichtung",
            "dbc_thermal_conductivity": "Al₂O₃: 24-28 W/mK AlN: 170-200 W/mK In Dickenrichtung",
            "dbc_thermal_note": "In Dickenrichtung",
            "htcc_thermal_conductivity": "Al₂O₃-basiert: 15-30 W/mK Hinweis: Leiter ist W/Mo (nicht Cu) Geringer als DPC/DBC aufgrund der W/Mo-Metallisierung",
            ...
            "dpc_conductor": "Galvanisch abgeschiedenes Kupfer (Cu) Typischer spez. Widerstand: 1,7 µΩ·cm",
            "dpc_conductor_note": "Typischer spez. Widerstand: 1,7 µΩ·cm",
            "dbc_conductor": "Verbundene Kupferfolie (Cu) Sauerstofffreies Kupfer, typisch 99,99 % Reinheit",
            "dbc_conductor_note": "Sauerstofffreies Kupfer, typisch 99,99 % Reinheit",
            "htcc_conductor": "Wolfram (W) oder Molybdän (Mo) Mit Keramik ko-gesintert, erfordert Nachbeschichtung",
            "htcc_conductor_note": "Mit Keramik ko-gesintert, erfordert Nachbeschichtung",

            "feature_conductor_thickness": "Leiterdicke",
            "dpc_conductor_thickness": "5-100 µm (galvanisch) Kontrolliert durch Galvanisierungszeit",
            "dpc_conductor_thickness_note": "Kontrolliert durch Galvanisierungszeit",
            "dbc_conductor_thickness": "100-300 µm (Folie) Standard: 0,2 mm, 0,3 mm, 0,4 mm",
            "dbc_conductor_thickness_note": "Standard: 0,2 mm, 0,3 mm, 0,4 mm",
            "htcc_conductor_thickness": "10-20 µm (gedruckt) Nach dem Ko-Sintern (vor der Beschichtung)",
            "htcc_conductor_thickness_note": "Nach dem Ko-Sintern (vor der Beschichtung)",

            "feature_line_width": "Min. Leiterbahn-/Abstand-Breite",
            "dpc_line_width": "20/20 µm Mit Fotolithografie",
            "dpc_line_width_note": "Mit Fotolithografie",
            "dbc_line_width": "150/150 µm Laser- oder chemisch geätzt",
            "dbc_line_width_note": "Laser- oder chemisch geätzt",
            "htcc_line_width": "100/100 µm Siebdruck, ko-gesintert",
            "htcc_line_width_note": "Siebdruck, ko-gesintert",

            "feature_via": "Durchkontaktierungs-Durchmesser (Min.)",
            "dpc_via": "50 µm (lasergebohrt) Durchkontaktierung galvanisch ausgefüllt",
            "dpc_via_note": "Durchkontaktierung galvanisch ausgefüllt",
            "dbc_via": "Nicht typisch Mit zusätzlicher Verarbeitung möglich",
            "dbc_via_note": "Mit zusätzlicher Verarbeitung möglich",
            "htcc_via": "100 µm (gestanzt) Mit W/Mo-Paste gefüllt",
            "htcc_via_note": "Mit W/Mo-Paste gefüllt",

            "feature_bond_strength": "Verbundfestigkeit (Keramik zu Metall)",
            "dpc_bond_strength": "30-40 MPa Ti/Cu-Saatlagen-Haftung",
            "dpc_bond_strength_note": "Ti/Cu-Saatlagen-Haftung",
            "dbc_bond_strength": ">20 MPa Cu-O-eutektischer Verbund",
            "dbc_bond_strength_note": "Cu-O-eutektischer Verbund",
            "htcc_bond_strength": "Integral (ko-gesintert) Keine separate Grenzfläche",
            "htcc_bond_strength_note": "Keine separate Grenzfläche",

            "feature_surface_finish": "Oberflächenveredelungs-Optionen",
            "dpc_surface_finish": "ENIG, ENEPIG, Immissionszinn Galvanisches Ni/Au, OSP Direkt auf galvanisiertem Kupfer",
            "dpc_surface_finish_note": "Direkt auf galvanisiertem Kupfer",
            "dbc_surface_finish": "Blankkupfer, Immissionszinn ENIG, Direkte Lötbeschichtung Kann Ni-Sperrschicht erfordern",
            "dbc_surface_finish_note": "Kann Ni-Sperrschicht erfordern",
            "htcc_surface_finish": "ENIG, ENEPIG erforderlich Galvanisches Ni/Au/Sn W/Mo nicht lötbar im gesinterten Zustand",
            "htcc_surface_finish_note": "W/Mo nicht lötbar im gesinterten Zustand",

            "feature_thermal_cycling": "Thermische Zyklusleistung",
            "dpc_thermal_cycling": "-55°C bis 150°C, 500 Zyklen Begrenzt durch CTE-Fehlanpassung des galvanischen Kupfers",
            "dpc_thermal_cycling_note": "Begrenzt durch CTE-Fehlanpassung des galvanischen Kupfers",
            "dbc_thermal_cycling": "-55°C bis 150°C, 1000+ Zyklen Hervorragend für Leistungszyklen",
            "dbc_thermal_cycling_note": "Hervorragend für Leistungszyklen",
            "htcc_thermal_cycling": "-55°C bis 150°C, 1000+ Zyklen Hervorragende hermetische Stabilität",
            "htcc_thermal_cycling_note": "Hervorragende hermetische Stabilität",

            "feature_multilayer": "Mehrlagen-Fähigkeit",
            "dpc_multilayer": "1-2 leitfähige Lagen Zweiseitig mit durchkontaktierten Bohrungen",
            "dpc_multilayer_note": "Zweiseitig mit durchkontaktierten Bohrungen",
            "dbc_multilayer": "1-2 Lagen (verbunden) Zwei DBCs können verbunden werden",
            "dbc_multilayer_note": "Zwei DBCs können verbunden werden",
            "htcc_multilayer": "2-50+ Lagen Echte 3D-Strukturen mit Kavitäten",
            "htcc_multilayer_note": "Echte 3D-Strukturen mit Kavitäten",

            "feature_applications": "Hauptanwendungen",
            "dpc_apps": "• HF-/Mikrowellenschaltungen • Feinstleiter-LED-Arrays • Sensor-Gehäuse • TEC-Module Wo Präzisionsmerkmale benötigt werden",
            "dpc_apps_note": "Wo Präzisionsmerkmale benötigt werden",
            "dbc_apps": "• IGBT-Leistungsmodule • EV-Antriebsumrichter • Hochstrom-Sammelschienen • Solarwechselrichter Hohe Leistung, hoher Strom",
            "dbc_apps_note": "Hohe Leistung, hoher Strom",
            "htcc_apps": "• Hermetische HF-Gehäuse • Luft- und Raumfahrt-Elektronik • Multi-Chip-Module (MCM) • Hochzuverlässige Sensoren Extreme Umgebungen",
            "htcc_apps_note": "Extreme Umgebungen",

            "feature_cost": "Relativer Kostenfaktor",
            "dpc_cost": "Mittel bis Hoch Fotolithografie erhöht Kosten",
            "dpc_cost_note": "Fotolithografie erhöht Kosten",
            "dbc_cost": "Niedrig bis Mittel Massenprozess, gut für große Flächen",
            "dbc_cost_note": "Massenprozess, gut für große Flächen",
            "htcc_cost": "Hoch (Einrichtung) Mittel (Volumen) Hohe NRE, Skaleneffekte",
            ...
            "dpc_recommendation": "DPC wählen, wenn: • Feinstrukturen <100µm erforderlich • ENIG/ENEPIG-Oberfläche benötigt • HF-Leistung kritisch • Kleine Serie, schneller Prototyp",
            "dbc_recommendation_title": "DBC wählen, wenn:",
            "dbc_recommendation": "DBC wählen, wenn: • Hoher Strom (>50A) erforderlich • Überlegene thermische Zyklusleistung benötigt • Dickes Kupfer (0,3mm+) erforderlich • Kostenempfindliche Großserie",
            "htcc_recommendation_title": "HTCC wählen, wenn:",
            "htcc_recommendation": "HTCC wählen, wenn: • Hermetische Dichtung erforderlich • Mehrlagen (>4 Lagen) benötigt • 3D-Strukturen/Kavitäten benötigt • Betrieb in extremen Umgebungen",
